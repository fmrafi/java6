 ...
 */
 import java.lang.String;
     ...
     import java.io.*;
     import javax.swing.*;
public class name_4_1 extends javax.swing.JFrame {
ResultSet rs;
           Statement sta;
...
s.show();// TODO add your handling code here:
   ...
   Jdbc j=new Jdbc();
     ...
     String search="select * from doctor_1 where name like '"+name+"%'";
...
id1=id1+"\n";
 ...
 Jdbc j=new Jdbc();
  ...
  //   no=txtroom_no.getText();
     ...
     String name=jTextField1.getText();
       System.out.println(name);
     String search="select * from doctor_1 where  duty_time like '"+name+"%'";
	     rs=j.find_statement(search);
String id1="";
String id2="     id         name     \n\n";
String id3="------------|---------\n\n";
...
id1=id1+"\n";
 ...
 Jdbc j=new Jdbc();
  ...
  //   no=txtroom_no.getText();
     ...
     String name=jTextField1.getText();
       System.out.println(name);
     String search="select * from doctor_1 where  duty_date like '"+name+"%'";
	     rs=j.find_statement(search);
String id1="";
String id2="     id         name     \n\n";
String id3="------------|---------\n\n";
