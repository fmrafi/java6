...
public class Add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setIconImages(null);
        setPreferredSize(new java.awt.Dimension(688, 483));
        setResizable(false);
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bloodbankmanegment/add user.png"))); // NOI18N
        ...
        Blood.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AB+", "AB-", "A+", "A-", "B+", "B-", "O+", "O-" }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(Mobile, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String Query = "INSERT INTO BloodBank (NAME , BLOOD, MOBILE,ADDRESS, SEX,ID,AGE,DAY,MONTH,DYEAR) "+ "VALUES ('"+Name.getText()+"', '"+Blood.getSelectedItem()+"', '"+Mobile.getText()+"', '"+Address.getText()+"', '"+Sex.getSelectedItem()+"', '"+ID.getText()+"',  '"+Age.getText()+"','','','')";
            
             stmt.execute(Query);
             JOptionPane.showMessageDialog(null, " Added to database");
             
            Name.setText(null);         
            Blood.setSelectedItem(00);
            Mobile.setText(null);
            Age.setText(null);
            ID.setText(null);
